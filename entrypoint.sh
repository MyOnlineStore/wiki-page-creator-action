...
for i in $(find $MD_FOLDER -maxdepth 1 -regextype posix-extended -regex '.*\.(asciidoc|creole|md|markdown|mediawiki|org|pod|rest|rdoc|textile|txt)' -execdir basename '{}' ';'); do
    echo $i
